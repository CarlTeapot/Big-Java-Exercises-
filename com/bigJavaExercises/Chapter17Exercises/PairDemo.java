...
public class PairDemo {
    public static void main(String[] args) {
        ...
        Pair<String> result = firstContaining(names, "a");
     ...
     * match.
     */
    public static Pair<String> firstContaining(
            String[] strings, String sub) {
        for (int i = 0; i < strings.length; i++) {
            if (strings[i].contains(sub)) {
                return new Pair<String>(strings[i], "xd");
            }
        }
        return new Pair<String>(null, null);
    }
